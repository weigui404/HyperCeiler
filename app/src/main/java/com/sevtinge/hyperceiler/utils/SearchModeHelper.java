...
public class SearchModeHelper {
    ...
    public static SearchActionMode startSearchMode(AppCompatActivity fragment, RecyclerView resultView, View contentView, View anchorView, View animateView, TextWatcher watcher) {
